...
public class Exercicio24 {
	...
	public static void main(String[] Args)
    {
        ...
        double litros = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade de litros:"));
        String tipoCombustivel = JOptionPane.showInputDialog("Informe a Letra G Para gasolina e A para Alcool:");
