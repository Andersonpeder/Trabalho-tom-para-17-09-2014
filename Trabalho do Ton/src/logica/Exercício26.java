	 ...
	 public static void main(String[] Args)
	    {
	        ...
	        double codFor = Integer.parseInt(JOptionPane.showInputDialog("Informe o Codigo do Produto"));
	        double quantidade = Integer.parseInt(JOptionPane.showInputDialog("Informe a quantidade comprada"));
